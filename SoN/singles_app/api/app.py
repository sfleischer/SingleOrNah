...
def start(kwargs):
    ...
    # {'username': , 'media_types': ['image', 'video', 'story'], 'media_metadata': False, 'usernames': ['jhuanghuang'], 'verbose': 0, 'maximum': 0, 'login_user': None, 'login_only': False, 'destination': './', 'quiet': False, 'comments': False, 'filename': None, 'filter': None, 'search_location': False, 'tag': False, 'location': False, 'login_pass': None, 'retain_username': False, 'include_location': False, 'latest': False}
